...
public class DDFImpl extends FBase{
	...
	public Element getMessage(String html){
		...
		if (null == name || "".equals(name.trim()) || null == price || "0".equals(price)) return null;
		if (null == type || "".equals(type.trim())) return null;
		name = name.trim();
		if (null == url || "".equals(url) || null == murl || "".equals(murl)) return null;
	...
	protected String getMurl(String url){
